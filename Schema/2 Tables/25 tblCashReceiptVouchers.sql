IF OBJECT_ID('tblCashReceiptVouchers') IS NULL
	CREATE TABLE tblCashReceiptVouchers(
		...
		AmountPaid MONEY NOT NULL CONSTRAINT DF_tblCashReceiptVouchers_AmountPaid DEFAULT 0,
		AmountApplied MONEY NOT NULL CONSTRAINT DF_tblCashReceiptVouchers_AmountApplied DEFAULT 0,
