...
IF NULLIF(@Id, 0) IS NULL
	SELECT b.Id AS SourceId, b.TransactionNo, b.[Date],
		b.ReferenceNo, b.ReferenceNo2, b.WithholdingTax,
		b.NetAmount, b.Balance, 0 AS AppliedAmount,
		0 AS AmountToApply, b.Balance AS OldBalance
	FROM tblBills b
...
ELSE
	SELECT bpbd.SourceId, b.TransactionNo, b.[Date],
		b.ReferenceNo, b.ReferenceNo2, b.WithholdingTax,
		b.NetAmount, b.Balance, bpbd.AppliedAmount,
		0 AS AmountToApply, b.Balance + tmp.Applied AS OldBalance
