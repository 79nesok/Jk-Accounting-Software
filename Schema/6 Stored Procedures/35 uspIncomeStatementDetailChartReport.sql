IF OBJECT_ID('uspIncomeStatementDetailChartReport') IS NOT NULL
	DROP PROCEDURE uspIncomeStatementDetailChartReport
GO

CREATE PROCEDURE uspIncomeStatementDetailChartReport(@CompanyId INT, @FromDate DATETIME, @ToDate DATETIME)
AS
SET NOCOUNT ON
