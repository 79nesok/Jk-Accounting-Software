...
--Maintenance
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = NULL, @Name = 'Chart of Accounts', @ListForm = NULL, @MasterForm = NULL, @Index = 0
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Chart of Accounts', @Name = 'Assets', @ListForm = 'EAssetsListForm', @MasterForm = NULL, @Index = 1
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Chart of Accounts', @Name = 'Liabilities', @ListForm = 'ELiabilitiesListForm', @MasterForm = 'EAccountForm', @Index = 2
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Chart of Accounts', @Name = 'Equities', @ListForm = 'EEquitiesListForm', @MasterForm = 'EAccountForm', @Index = 3
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Chart of Accounts', @Name = 'Income', @ListForm = 'EIncomeListForm', @MasterForm = 'EAccountForm', @Index = 4
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Chart of Accounts', @Name = 'Expenses', @ListForm = 'EExpensesListForm', @MasterForm = 'EAccountForm', @Index = 5

EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = NULL, @Name = 'Items', @ListForm = 'EItemsListForm', @MasterForm = 'EItemForm', @Index = 6

EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = NULL, @Name = 'Payment Methods', @ListForm = 'EPaymentMethodsListForm', @MasterForm = 'EPaymentMethodForm', @Index = 7

EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = NULL, @Name = 'Subsidiaries', @ListForm = NULL, @MasterForm = NULL, @Index = 8
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Subsidiaries', @Name = 'Customers', @ListForm = 'ECustomersListForm', @MasterForm = 'ESubsidiaryForm', @Index = 9
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Subsidiaries', @Name = 'Suppliers', @ListForm = 'ESuppliersListForm', @MasterForm = 'ESubsidiaryForm', @Index = 10
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Subsidiaries', @Name = 'Employees', @ListForm = 'EEmployeesListForm', @MasterForm = 'ESubsidiaryForm', @Index = 11
EXEC uspAddSystemSubCategory @Category = 'Maintenance', @Parent = 'Subsidiaries', @Name = 'Others', @ListForm = 'EOthersListForm', @MasterForm = 'ESubsidiaryForm', @Index = 12
